...
import org.example.batchtest.entity.AfterEntity;
import org.example.batchtest.repository.AfterRepository;
...
public class FourthBatch {
    ...
    public ItemStreamReader<Row> excelReader() {
        ...
        try {
            return new ExcelRowReader("C:\\Users\\namju\\Desktop\\기타 프젝\\table.xlsx");
            //리눅스나 맥은 /User/형태로
        } catch (IOException e) {
    ...
    // Row 형태로 받아서 AfterEntity 형태로 변환
    @Bean
