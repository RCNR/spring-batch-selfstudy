...
import org.example.batchtest.entity.BeforeEntity;
import org.example.batchtest.repository.BeforeRepository;
...
public class FifthBatch {
    ...
    public ItemStreamWriter<BeforeEntity> excelWriter() {
        ...
        try {
            return new ExcelRowWriter("C:\\Users\\cjsla\\OneDrive\\바탕 화면\\혼자서2\\result.xlsx");
            //리눅스나 맥은 /User/형태로
        } catch (IOException e) {
